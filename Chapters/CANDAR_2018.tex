...
%In addition, we show explicit formulas to compute the GLV method together with Straus-Shamir simultaneous multi-scalar multiplication technique for 2, 4 and 8 dimensions in $\g2$ group. 
...
%%---------------------------------------------------PROPOSAL----------------
\section{Proposed GLV technique for \texorpdfstring{$\g2$}{} Rational Point on  KSS-16 Curve} \index{KSS-16: $\g{2} SCM}
\label{Proposal}

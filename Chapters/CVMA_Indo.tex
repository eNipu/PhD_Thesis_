...
The parameter is chosen according to \cite{sylvain_new_param}'s suggestion for to make DLP size secure enough against exTNFS \cite{C:KimBar16} as is shown in Table \ref{parameters}.

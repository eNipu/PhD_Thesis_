...
In \chref{ch:ijnc2017}, we derived twist property for target elliptic curves for 192-bit security level and compared their performances concerning scalar multiplication.
...
\chref{ch:candar2018} shows the   $\g{2}$  scalar multiplication with by applying different dimension of GLV decomposition.

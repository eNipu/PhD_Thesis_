...
\item $k=6e$ (sextic twist), Barreto--Naehrig (BN) curve \cite{BN} has this form. \\
%\begin{subequations}
\begin{eqnarray*}
E : && y^2=x^3+b,\ b\in \F{p}{}, \\
E' : && y^2=x^3+bv^{-1},
...
Twisted Ate \cite{TAte}, \cite{tAteX} & \ \ $36\chi^3-18\chi^2+6\chi-1$\ \  & $E(\F{p}{})$ & $E(\F{p}{12})$ \\ \hline
Ate & $6\chi^2$ & $E(\F{p}{12})$ & $E(\F{p}{})$ \\ \hline
Devegili et al.'s Ate \cite{Devegili} & $6\chi^2$ & $E'(\F{p}{2})$ & $E(\F{p}{})$ \\ \hline

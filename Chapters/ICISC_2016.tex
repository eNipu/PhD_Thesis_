%An Improvement of Optimal-Ate Pairing on KSS-18 curve with Pseudo 12-sparse Multiplication
\section{Introduction}\label{ch3_section_1}
...
%-----------------------------------------------------------------------------------------------------------------------------------
\subsection{KSS Curve \index{KSS Curve}}
...
%-----------------------------------------------------------------------------------------------------------------------------------
\subsection{Towering Extension Field  \index{KSS-18: towering} \index{KSS-18: extension field}} \label{towering_optate_KSS18}
...
\begin{equation}
	(Q,P)=(f_{u,Q}\cdot f_{3,Q}^p\cdot l_{[u]Q,[3p]Q})^{\frac{p^{18}-1}{r}}\label{pairing},
\end{equation}
...
%
%
\begin{algorithm}[htbp]  \index{ KSS-18: Optimal-Ate}

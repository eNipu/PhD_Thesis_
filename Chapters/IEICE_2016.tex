...
%Points satisfying \eqref{eqn_ellipticcurve_chapter_g2scm_kss18} are known as rational points on the curve.
...
We recall \secref{towering_optate_KSS18} of \chref{ch_optate_kss18} for $\FQEN$ construction.
...
\subsection{Sextic Twist of KSS-18 Curve}
...
\subsection{\g1, \g2 and \g3 groups} In the context of pairing-based cryptography, especially on KSS-18 curve, three groups $\g1, \g2$, and $\mathbb{G}_3$ are considered. From \cite{PAIRING:MANS13}, we define $\g1$, $\g2$ and $\g3$ as follows:
...
\subsection{\texorpdfstring{$z$}{}-adic Representation of Scalar \texorpdfstring{$s$}{}} \label{section_zadic_chapter_g2scm_kss18}

...
There are several works \cite{nogami_scm_ate}\cite{sakemi_skew} on efficiently computing scalar multiplication defined over Barreto-Naehrig\cite{BN} curve along with efficient extension field arithmetic \cite{ef_ex}. 

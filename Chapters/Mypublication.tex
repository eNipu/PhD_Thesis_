...
%\begin{enumerate}
	...
	on KSS Curve with Pseudo 12-Sparse Multiplication". In: \textit{ICISC 2016}. Ed. by Seokhie Hong and Jong Hwan Park. Vol. 10157. LNCS. Springer, Heidelberg, Nov. 2016, pp. 208–219. \textsc{doi}: \href{https://doi.org/10.1007/978-3-319-53177-9_11}{\texttt{10.1007/978-3-319-\\53177-9\_11}}.
...
%	\item Yuki Nanjo, \textbf{Md. Al-Amin Khandaker}, Masaaki Shirase, Takuya Kusaka, and Yasuyuki Nogami. ``Efficient Ate-Based Pairing over the Attractive Classes of BN Curves''. In: \textit{WISA 2018}. To appear LNCS. Springer, Heidelberg,  Aug. 2018.  pp. ?–?. \textsc{doi}: \href{?}{\texttt{?}}. (Acceptance Ratio 22/44 = 50\%)
	...
	%(Acceptance Ratio 27/53 $\approx$ 50\%).
...
%\end{enumerate}
	...
	\normalsize
%\begin{enumerate}
	\item Yuki Nanjo,  \textbf{Md. Al-Amin Khandaker}, Takuya Kusaka, Yasuyuki Nogami. ``A Study on a Construction Method of Degree 18 Extension Field for Efficient Pairing over KSS Curves''. In: \textit{Computer Security Symposium  (CSS),  2018}, CD-ROM (2A3-1). 

...
\thesistitle{Improvements of Pairing-Based Cryptography: Committed to High-Level Security} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
%\chapter{CANDAR 2016} 
%\input{Chapters/CANDAR_2016}  // Merged in IJNC
\input{Chapters/IJNC_2016}

%\chapter{ICCIT 2016} 
%\input{Chapters/ICCIT_2016} %:  NO NEED s

\input{Chapters/IndoCrypt_OptAte_2017}
\input{Chapters/CVMA_Indo} 
\input{Chapters/CANDAR_2018} 
%\chapter{CSS 2017} 
%\input{Chapters/CSS_2017} //CHECK table

%%%\part{Works}
%\chapter{ICCE-TW 2016} 
%\input{Chapters/ICCE_TW_16} % NO NEED
%\chapter{ITC CSCC 2017} 
%\input{Chapters/ITC_CSCC_2017} //Skew FM table
\input{Chapters/Gen_Conclusion}
%----------------------------------------------------------------------------------------

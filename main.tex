...
\addbibresource{custombib/thesis_bib.bib}
...
\thesistitle{Efficient Software Implementation of Pairing-Based Cryptographic Primitives for High-level Security for IoT} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
To my parents who brought me to this world.
And to my wife \textit{Shama} who sacrificed most during my Ph.D. journey.} 
...
\include{Chapters/ResearchActivity} 
%\addchaptertocentry
...
%\input{Chapters/ICCE_TW_16}
%\chapter{WISA 2016} 
%\input{Chapters/WISA_2016} 
%\chapter{IEICE 2016} 
%\input{Chapters/IEICE_2016} 
%\chapter{CANDAR 2016} 
%\input{Chapters/CANDAR_2016} 
%\chapter{IJNC 2016}
%\input{Chapters/IJNC_2016}
%\chapter{ICISC 2016} 
%\input{Chapters/ICISC_2016} 
%\chapter{ICCIT 2016} 
%\input{Chapters/ICCIT_2016}
%\chapter{INDOCRYPT 2017} 
%\input{Chapters/IndoCrypt_OptAte_2017}
%\chapter{INDOCRYPT Revisited Joournal 2017} 
%\input{Chapters/CVMA_Indo} 
%\chapter{CSS 2017} 
%\input{Chapters/CSS_2017} 
%\chapter{ITC CSCC 2017} 
%\input{Chapters/ITC_CSCC_2017} 
...
%\input{Appendices/Appendix_IJNC2016}
